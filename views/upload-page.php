...
<div class="wrap safefonts-admin-wrap">
    ...
    <!-- WebFontDownloader Info Box -->
    <div class="notice notice-info" style="display: flex; align-items: center; padding: 12px;">
        <p style="margin: 0; flex-grow: 1;">
            ℹ️ <?php esc_html_e('Need Google Fonts? Download them for free at WebFontDownloader', 'safefonts'); ?>
        </p>
        <a href="https://webfontdownloader.safefonts.com" target="_blank" rel="noopener noreferrer" class="button button-secondary">
            <?php esc_html_e('Download Fonts', 'safefonts'); ?> →
        </a>
    </div>
